...
export default class AddForm extends Component {
  ...
  addData() {
    ...
    if (this.props.displayData.formName === 'department') {
      const id = this.props.depsList[this.props.depsList.length - 1].id + 1;
    ...
    return (
      ...
      >
        <div className="card-header d-flex justify-content-between">
          <h5 className="pt-2">
            Form to add
            {this.props.displayData.formName}
          </h5>
        ...
        <div className="card-body text-secondary col-lg-6 m-auto">
          <div className="input-group">
            ...
            <input
              ...
              placeholder={`Enter name of ${this.props.displayData.formName}`}
            />
          </div>
          {
            !this.props.isValid
            && (
              <small className="form-text text-danger">
                Text field "
                {this.props.displayData.inputName}
                " must be filled
              </small>
            )
          }
        ...
        <div
          className="btn btn-info mt-3 p-2 font-weight-bold text-uppercase"
