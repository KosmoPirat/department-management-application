...
export default class MainItem extends Component {
  render() {
    const d_employees = this.props.employeesList.filter((empl) => this.props.d_EmployeesIds.includes(empl.id));
    const employeesListItem = d_employees.map((empl, index) => <MainEmployeesItem key={index} e_name={empl.e_name} />);
    return (
      <>
        <div className="col-md-4 mb-4">
          <div className="card p-0 h-400">
            ...
            <ul className="list-group list-group-flush overflow-auto">
              {
                employeesListItem.length ? employeesListItem
                  : (
